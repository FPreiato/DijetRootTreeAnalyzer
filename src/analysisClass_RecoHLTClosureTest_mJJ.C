...
void analysisClass::Loop()
{
   ...
   //   for (Long64_t jentry=0; jentry<5000;jentry++) { //runnig over few events
	 ...
	 CreateAndFillUserTProfile( Form("pT_vs_MjjHLT_%s", Bin.c_str()),  500, 0., 5000., 0., 5000., mjj, widejets[0].Pt() );	      
	   ...
	   if(verbose) std::cout<<"deltaEtaCut_ = "<< DeltaEtaJJ_ << std::endl;
	   if(verbose) std::cout<<"MJJCut_ = "<< MJJCut_ << std::endl;
	   ...
	   if(deltaR_min.at(0) < DeltaR_ && deltaR_min.at(1) < DeltaR_){
		 ...
		 */
		 ...
		 CreateAndFillUserTH1D("MJJ_WideJetHLT", 30, 0, 3000, mjjCorr );
		 CreateAndFillUserTH1D("MJJ_WideJetReco", 30, 0, 3000, mjjreco );
		 CreateAndFillUserTH2D("MJJ_WideJet", 30, 0, 3000, 30, 0, 3000, mjjreco, mjjCorr );
		 
		 // bias per la variabile mJJ
		 // mJJ(Reco) - mJJ(HLT) / mJJ(HLT)
		 double mJJBias =  (mjjreco - mjjCorr) / mjjCorr;
		 if(verbose) std::cout<<"mJJ Bias= "<<mJJBias << std::endl;
		 
		 int MjjBin   = mMjjBinning.getBin( mjjCorr );
		 ...
		 CreateAndFillUserTProfile("mJJ_vs_NvtxHLT",  50, 0., 50., 0., 5000., nVtx, mjjCorr );
		 ...
		 CreateAndFillUserTProfile("mJJ_vs_MjjHLT",  50, 0., 5000., 0., 5000., mjjCorr, mjjCorr );	      
		 CreateAndFillUserTProfile( Form("mJJBias_vs_Mjj_%s", mJJBin.c_str()),  30, 0., 3000., -2., 2.,  mjjCorr, mJJBias );
		 CreateAndFillUserTProfile( Form("mJJ_vs_MjjReco_%s", mJJBin.c_str()), 30, 0., 3000., 0., 3000., mjjreco, mjjreco );
		 CreateAndFillUserTProfile( Form("mJJ_vs_MjjHLT_%s", mJJBin.c_str()),  30, 0., 3000., 0., 3000., mjjCorr, mjjCorr );	      
