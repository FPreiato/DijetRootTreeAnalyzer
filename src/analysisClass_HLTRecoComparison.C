   ...
   //   for (Long64_t jentry=0; jentry<10;jentry++) { //runnig over 2 events
	 ...
	 if(AK4Comparison){
	   ...
	   if( DeltaReco1HLT1 <= DeltaReco1HLT2 )
	     {
	       IdxMatched.push_back( 0 ); // index HLT jet
	       IdxMatched.push_back( 1 ); // index HLT jet
	   ...
	   for(int ii=0; ii<deltaR_min.size(); ii++){
	     ...
	     if(deltaR_min.at(ii)< DeltaR_ ){   
	       ...
	       if(verbose){
		 std::cout<<"AK4"<<std::endl;
		 std::cout<<"Jet Reco number "<< ii <<std::endl;
		 std::cout<<"Pt= "<< AK4recojets[ii].Pt()<<" Eta= "<<AK4recojets[ii].Eta()<< " Phi= "<<AK4recojets[ii].Phi()  <<std::endl;
		 std::cout<<"HLT" <<std::endl;
		 std::cout<<"Pt= "<< AK4jets[IdxMatched.at(ii)].Pt()<<" Eta= "<<AK4jets[IdxMatched.at(ii)].Eta()<< " Phi= "<<AK4jets[IdxMatched.at(ii)].Phi()  <<std::endl;
	       }	 

	       // Reco variables
	       CreateAndFillUserTH1D("AK4_pT_JetReco", 300, 0, 3000, AK4recojets[ii].Pt() );
	       CreateAndFillUserTH1D("AK4_Eta_JetReco", 100, -2.5, 2.5, AK4recojets[ii].Eta() );
	       CreateAndFillUserTH1D("AK4_Phi_JetReco", 100, -3.15, 3.15, AK4recojets[ii].Phi() );
	       CreateAndFillUserTH1D("AK4_chargedHadEnFracReco", 100, 0, 1, chargedHadEnFracReco[ii] );
	       CreateAndFillUserTH1D("AK4_neutrHadEnFracReco", 100, 0, 1, neutrHadEnFracReco[ii] );
	       CreateAndFillUserTH1D("AK4_chargedElectromFracReco", 100, 0, 1, chargedElectromFracReco[ii] );
	       CreateAndFillUserTH1D("AK4_neutrElectromFracReco", 100, 0, 1, neutrElectromFracReco[ii] );
	       CreateAndFillUserTH1D("AK4_muEnFracReco", 100, 0, 1, muEnFracReco[ii] );
	       CreateAndFillUserTH1D("AK4_chargedMultReco", 100, 0, 100, chargedMultReco[ii] );
	       CreateAndFillUserTH1D("AK4_neutrMultReco", 100, 0, 100, neutrMultReco[ii] );
	       CreateAndFillUserTH1D("AK4_photonMultReco", 100, 0, 100, photonMultReco[ii] );
	       CreateAndFillUserTH1D("AK4_jetCSVAK4Reco", 100, 0, 2, jetCSVAK4Reco[ii] );
	       // HLT variables
	       CreateAndFillUserTH1D("AK4_pT_JetHLT", 300, 0, 3000, AK4jets[IdxMatched.at(ii)].Pt() );
	       CreateAndFillUserTH1D("AK4_Eta_JetHLT", 100, -2.5, 2.5, AK4jets[IdxMatched.at(ii)].Eta() );
	       CreateAndFillUserTH1D("AK4_Phi_JetHLT", 100, -3.15, 3.15, AK4jets[IdxMatched.at(ii)].Phi() );
	       CreateAndFillUserTH1D("AK4_chargedHadEnFracHLT", 100, 0, 1, chargedHadEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_neutrHadEnFracHLT", 100, 0, 1, neutrHadEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_chargedElectromFracHLT", 100, 0, 1, chargedElectromFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_neutrElectromFracHLT", 100, 0, 1, neutrElectromFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_muEnFracHLT", 100, 0, 1, muEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_chargedMultHLT", 100, 0, 100, chargedMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_neutrMultHLT", 100, 0, 100, neutrMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_photonMultHLT", 100, 0, 100, photonMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH1D("AK4_jetCSVAK4HLT", 100, 0, 2, jetCSVAK4[IdxMatched.at(ii)] );
	       // Reco vs HLT
	       CreateAndFillUserTH2D("AK4_pT_Jet", 300, 0, 3000, 300, 0, 3000, AK4recojets[ii].Pt(), AK4jets[IdxMatched.at(ii)].Pt() );
	       CreateAndFillUserTH2D("AK4_Eta_Jet", 100, -2.5, 2.5, 100, -2.5, 2.5, AK4recojets[ii].Eta(), AK4jets[IdxMatched.at(ii)].Eta() );
	       CreateAndFillUserTH2D("AK4_Phi_Jet", 100, -3.15, 3.15, 100, -3.15, 3.15, AK4recojets[ii].Phi(), AK4jets[IdxMatched.at(ii)].Phi() );
	       CreateAndFillUserTH2D("AK4_chargedHadEnFrac", 100, 0, 1, 100, 0, 1, chargedHadEnFracReco[ii], chargedHadEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_neutrHadEnFrac", 100, 0, 1, 100, 0, 1, neutrHadEnFracReco[ii], neutrHadEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_chargedElectromFrac", 100, 0, 1, 100, 0, 1, chargedElectromFracReco[ii], chargedElectromFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_neutrElectromFrac", 100, 0, 1, 100, 0, 1, neutrElectromFracReco[ii], neutrElectromFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_muEnFrac", 100, 0, 1, 100, 0, 1, muEnFracReco[ii], muEnFrac[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_chargedMult", 100, 0, 100, 100, 0, 100, chargedMultReco[ii], chargedMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_neutrMult", 100, 0, 100, 100, 0, 100, neutrMultReco[ii], neutrMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_photonMult", 100, 0, 100, 100, 0, 100, photonMultReco[ii], photonMult[IdxMatched.at(ii)] );
	       CreateAndFillUserTH2D("AK4_jetCSVAK4", 100, 0, 2, 100, 0, 2, jetCSVAK4Reco[ii], jetCSVAK4[IdxMatched.at(ii)] );

	       // Bias in pT AK4
	       // pT(HLT) - pT(Reco) / pT(Reco)	   
	       double pTBias = (AK4jets[IdxMatched.at(ii)].Pt() - AK4recojets[ii].Pt() )/ AK4recojets[ii].Pt(); 
	       if(verbose) std::cout<<"pT Bias= "<<pTBias << std::endl;

	       //	       int AK4_etaBin = mEtaBinning.getBin( fabs(AK4recojets[ii].Eta()) ); // modulo
	       int AK4_etaBin = mEtaBinning.getBin( AK4recojets[ii].Eta() ); //separo negativi da positivi
	       int AK4_ptBin   = mPtBinning.getPtBin( AK4recojets[ii].Pt() );
	       ...
	       CreateAndFillUserTProfile("AK4_pT_vs_NvtxReco", 50, 0., 50., 0., 5000., nVtxreco, AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile("AK4_pT_vs_NvtxHLT",  50, 0., 50., 0., 5000., nVtx, AK4jets[IdxMatched.at(ii)].Pt() );
	       CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Nvtx_%s", AK4_Bin.c_str()),  50, 0., 50., -2., 2.,      nVtxreco, pTBias );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_NvtxReco_%s", AK4_Bin.c_str()), 50, 0., 50., 0., 5000., nVtxreco, AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_NvtxHLT_%s", AK4_Bin.c_str()),  50, 0., 50., 0., 5000., nVtx, AK4jets[IdxMatched.at(ii)].Pt() );
	       ////// TProfile: pTBias vs Eta
	       CreateAndFillUserTProfile("AK4_pTBias_vs_Eta",  20, -2.5, 2.5, -2., 2.,      AK4recojets[ii].Eta(), pTBias );
	       CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Eta_VariableBin_%s", AK4_PtBin.c_str()),  binnumEta, etaBins, -2., 2., AK4recojets[ii].Eta(), pTBias );
	       CreateAndFillUserTProfile("AK4_pT_vs_EtaReco", 20, -2.5, 2.5, 0., 5000., AK4recojets[ii].Eta(), AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile("AK4_pT_vs_EtaHLT",  20, -2.5, 2.5, 0., 5000., AK4jets[IdxMatched.at(ii)].Eta(), AK4jets[IdxMatched.at(ii)].Pt() );
	       CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Eta_%s", AK4_PtBin.c_str()),  20, -2.5, 2.5, -2., 2.,      AK4recojets[ii].Eta(), pTBias );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_EtaReco_%s", AK4_PtBin.c_str()), 20, -2.5, 2.5, 0., 5000., AK4recojets[ii].Eta(), AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_EtaHLT_%s", AK4_PtBin.c_str()),  20, -2.5, 2.5, 0., 5000., AK4jets[IdxMatched.at(ii)].Eta(), AK4jets[IdxMatched.at(ii)].Pt() );	       
	       ////// TProfile: pTBias vs Pt
	       CreateAndFillUserTProfile("AK4_pTBias_vs_Pt",  50, 0., 5000., -2., 2.,      AK4recojets[ii].Pt(), pTBias );
	       CreateAndFillUserTProfile("AK4_pT_vs_PtReco", 50, 0., 5000., 0., 5000., AK4recojets[ii].Pt(), AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile("AK4_pT_vs_PtHLT",  50, 0., 5000., 0., 5000., AK4jets[IdxMatched.at(ii)].Pt(), AK4jets[IdxMatched.at(ii)].Pt() );	      
	       CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Pt_%s", AK4_EtaBin.c_str()),  50, 0., 5000., -2., 2.,      AK4recojets[ii].Pt(), pTBias );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_PtReco_%s", AK4_EtaBin.c_str()), 50, 0., 5000., 0., 5000., AK4recojets[ii].Pt(), AK4recojets[ii].Pt() );
	       CreateAndFillUserTProfile( Form("AK4_pT_vs_PtHLT_%s", AK4_EtaBin.c_str()),  50, 0., 5000., 0., 5000., AK4jets[IdxMatched.at(ii)].Pt(), AK4jets[IdxMatched.at(ii)].Pt() );	      

	       if( fabs(AK4recojets[ii].Eta())<=1.5 )
		 {
		   CreateAndFillUserTProfile("AK4_pTBias_vs_Pt_Barrel",  50, 0., 5000., -2., 2., AK4recojets[ii].Pt(), pTBias );		 
		 }else if( fabs(AK4recojets[ii].Eta())>1.5 && fabs(AK4recojets[ii].Eta())<=2.5 )
		 {
		   CreateAndFillUserTProfile("AK4_pTBias_vs_Pt_Endcap",  50, 0., 5000., -2., 2., AK4recojets[ii].Pt(), pTBias );		 		 
		 }
	   ...
	   ////// End AK4 analysis	     	  
		 ...
		 if(deltaR_min.at(ii)< DeltaR_ ){ // dR check
		   ...
		   if(verbose){
		     ...
		     std::cout<<"Widejet Reco " <<ii <<std::endl;
		     std::cout<<"Reco"<<std::endl;
		     std::cout<<"Pt= "<< widejetsReco[ii].Pt()<<" Eta= "<<widejetsReco[ii].Eta()<< " Phi= "<<widejetsReco[ii].Phi()  <<std::endl;
		     std::cout<<"HLT" <<std::endl;
		     std::cout<<"Index= "<< IdxMatched.at(ii)  <<std::endl;
		     std::cout<<"Pt= "<< widejets[IdxMatched.at(ii)].Pt()<<" Eta= "<<widejets[IdxMatched.at(ii)].Eta()<< " Phi= "<<widejets[IdxMatched.at(ii)].Phi()  <<std::endl;
		   }
	
		   // Reco variables
		   CreateAndFillUserTH1D("pT_WideJetReco", 300, 0, 3000, widejetsReco[ii].Pt()  );
		   CreateAndFillUserTH1D("Eta_WideJetReco", 100, -2.5, 2.5, widejetsReco[ii].Eta() );
		   CreateAndFillUserTH1D("Phi_WideJetReco", 100, -3.5, 3.5, widejetsReco[ii].Phi()  );
		   // HLT variables	       
		   CreateAndFillUserTH1D("pT_WideJetHLT", 300, 0, 3000, widejets[IdxMatched.at(ii)].Pt()  );
		   CreateAndFillUserTH1D("Eta_WideJetHLT", 100, -2.5, 2.5, widejets[IdxMatched.at(ii)].Eta()  );
		   CreateAndFillUserTH1D("Phi_WideJetHLT", 100, -3.5, 3.5, widejets[IdxMatched.at(ii)].Phi()  );
		   // Reco vs HLT
		   CreateAndFillUserTH2D("pT_WideJet", 300, 0, 3000, 300, 0, 3000, widejetsReco[ii].Pt(), widejets[IdxMatched.at(ii)].Pt() );
		   CreateAndFillUserTH2D("Eta_WideJet", 100, -2.5, 2.5, 100, -2.5, 2.5, widejetsReco[ii].Eta(), widejets[IdxMatched.at(ii)].Eta() );
		   CreateAndFillUserTH2D("Phi_WideJet", 100, -3.5, 3.5, 100, -3.5, 3.5, widejetsReco[ii].Phi(), widejets[IdxMatched.at(ii)].Phi() );
	 
		   double pTBias = ( widejets[IdxMatched.at(ii)].Pt() - widejetsReco[ii].Pt() )/ widejetsReco[ii].Pt() ; 
		   if(verbose) std::cout<<"pT Bias= "<<pTBias << std::endl;

		   int etaBin = mEtaBinning.getBin( fabs(widejetsReco[ii].Eta()) );
		   int ptBin   = mPtBinning.getPtBin( widejetsReco[ii].Pt() );
		   ...
		   if( verbose ){	       
		     cout<<"WideJet: |Eta| = "<< fabs( widejetsReco[ii].Eta() )<< " pT = "<< widejetsReco[ii].Pt() <<endl;
		   ...
		   CreateAndFillUserTProfile("pT_vs_NvtxReco", 50, 0., 50., 0., 5000., nVtxreco, widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile("pT_vs_NvtxHLT",  50, 0., 50., 0., 5000., nVtx, widejets[IdxMatched.at(ii)].Pt() );
		   CreateAndFillUserTProfile( Form("pTBias_vs_Nvtx_%s", Bin.c_str()),  50, 0., 50., -2., 2.,      nVtxreco, pTBias );
		   CreateAndFillUserTProfile( Form("pT_vs_NvtxReco_%s", Bin.c_str()), 50, 0., 50., 0., 5000., nVtxreco, widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile( Form("pT_vs_NvtxHLT_%s", Bin.c_str()),  50, 0., 50., 0., 5000., nVtx, widejets[IdxMatched.at(ii)].Pt() );
		   ////// TProfile: pTBias vs Eta
		   CreateAndFillUserTProfile("pTBias_vs_Eta",  20, -2.5, 2.5, -2., 2.,      widejetsReco[ii].Eta(), pTBias );
		   CreateAndFillUserTProfile("pT_vs_EtaReco", 20, -2.5, 2.5, 0., 5000., widejetsReco[ii].Eta(), widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile("pT_vs_EtaHLT",  20, -2.5, 2.5, 0., 5000., widejets[IdxMatched.at(ii)].Eta(), widejets[IdxMatched.at(ii)].Pt() );
		   CreateAndFillUserTProfile( Form("pTBias_vs_Eta_%s", PtBin.c_str()),  20, -2.5, 2.5, -2., 2.,      widejetsReco[ii].Eta(), pTBias );
		   CreateAndFillUserTProfile( Form("pT_vs_EtaReco_%s", PtBin.c_str()), 20, -2.5, 2.5, 0., 5000., widejetsReco[ii].Eta(), widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile( Form("pT_vs_EtaHLT_%s", PtBin.c_str()),  20, -2.5, 2.5, 0., 5000., widejets[IdxMatched.at(ii)].Eta(), widejets[IdxMatched.at(ii)].Pt() );
		   ////// TProfile: pTBias vs Pt
		   CreateAndFillUserTProfile("pTBias_vs_Pt",  50, 0., 5000., -2., 2.,      widejetsReco[ii].Pt(), pTBias );
		   CreateAndFillUserTProfile("pT_vs_PtReco", 50, 0., 5000., 0., 5000., widejetsReco[ii].Pt(), widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile("pT_vs_PtHLT",  50, 0., 5000., 0., 5000., widejets[IdxMatched.at(ii)].Pt(), widejets[IdxMatched.at(ii)].Pt() );	      
		   CreateAndFillUserTProfile( Form("pTBias_vs_Pt_%s", EtaBin.c_str()),  50, 0., 5000., -2., 2.,      widejetsReco[ii].Pt(), pTBias );
		   CreateAndFillUserTProfile( Form("pT_vs_PtReco_%s", EtaBin.c_str()), 50, 0., 5000., 0., 5000., widejetsReco[ii].Pt(), widejetsReco[ii].Pt() );
		   CreateAndFillUserTProfile( Form("pT_vs_PtHLT_%s", EtaBin.c_str()),  50, 0., 5000., 0., 5000., widejets[IdxMatched.at(ii)].Pt(), widejets[IdxMatched.at(ii)].Pt() );	      
		   /*
	       ////// TProfile: pTBias vs mJJ
	       CreateAndFillUserTProfile("pTBias_vs_Mjj",  500, 0., 5000., -2., 2.,      mjjreco, pTBias );
	       CreateAndFillUserTProfile("pT_vs_MjjReco", 500, 0., 5000., 0., 5000., mjjreco, widejetsReco[ii].Pt() );
	       CreateAndFillUserTProfile("pT_vs_MjjHLT",  500, 0., 5000., 0., 5000., mjj, widejets[IdxMatched.at(ii)].Pt() );	      
	       CreateAndFillUserTProfile( Form("pTBias_vs_Mjj_%s", Bin.c_str()),  500, 0., 5000., -2., 2.,      mjjreco, pTBias );
	       CreateAndFillUserTProfile( Form("pT_vs_MjjReco_%s", Bin.c_str()), 500, 0., 5000., 0., 5000., mjjreco, widejetsReco[ii].Pt() );
	       CreateAndFillUserTProfile( Form("pT_vs_MjjHLT_%s", Bin.c_str()),  500, 0., 5000., 0., 5000., mjj, widejets[IdxMatched.at(ii)].Pt() );	      
		   */	     
		 } // if matched
	       } // loop on jets
	       if(verbose){
		 ...
		 if(deltaR_min.at(0) < DeltaR_ && deltaR_min.at(1) < DeltaR_){
		   ...
		   CreateAndFillUserTProfile("mJJBias_vs_Eta",  20, -2.5, 2.5, -2., 2.,      widejetsReco[0].Eta(), mJJBias );
		   CreateAndFillUserTProfile("mJJ_vs_EtaReco", 20, -2.5, 2.5, 0., 5000., widejetsReco[0].Eta(), mjjreco );
		   CreateAndFillUserTProfile("mJJ_vs_EtaHLT",  20, -2.5, 2.5, 0., 5000., widejets[IdxMatched.at(0)].Eta(), mjj );
		   CreateAndFillUserTProfile( Form("mJJBias_vs_Eta_%s", mJJBin.c_str()),  20, -2.5, 2.5, -2., 2.,      widejetsReco[0].Eta(), mJJBias );
		   CreateAndFillUserTProfile( Form("mJJ_vs_EtaReco_%s", mJJBin.c_str()), 20, -2.5, 2.5, 0., 5000., widejetsReco[0].Eta(), mjjreco );
		   CreateAndFillUserTProfile( Form("mJJ_vs_EtaHLT_%s", mJJBin.c_str()),  20, -2.5, 2.5, 0., 5000., widejets[IdxMatched.at(0)].Eta(), mjj );		   
		   ////// TProfile: mJJBias vs Pt
		   CreateAndFillUserTProfile("mJJBias_vs_Pt",  50, 0., 5000., -2., 2.,      widejetsReco[0].Pt(), mJJBias );
		   CreateAndFillUserTProfile("mJJ_vs_PtReco", 50, 0., 5000., 0., 5000., widejetsReco[0].Pt(), mjjreco );
		   CreateAndFillUserTProfile("mJJ_vs_PtHLT",  50, 0., 5000., 0., 5000., widejets[IdxMatched.at(0)].Pt(), mjj );	      
		   CreateAndFillUserTProfile( Form("mJJBias_vs_Pt_%s", mJJBin.c_str()),  50, 0., 5000., -2., 2.,      widejetsReco[0].Pt(), mJJBias );
		   CreateAndFillUserTProfile( Form("mJJ_vs_PtReco_%s", mJJBin.c_str()), 50, 0., 5000., 0., 5000., widejetsReco[0].Pt(), mjjreco );
		   CreateAndFillUserTProfile( Form("mJJ_vs_PtHLT_%s", mJJBin.c_str()),  50, 0., 5000., 0., 5000., widejets[IdxMatched.at(0)].Pt(), mjj );	      	       
		 ////// TProfile: mJJBias vs mJJ
		 // questo e' quello importante!!! basta fittare questo e ho le correzioni
		 CreateAndFillUserTProfile("mJJBias_vs_Mjj",  25, 500., 3000., -2., 2.,  mjjreco, mJJBias );
		 ...
		 CreateAndFillUserTProfile( Form("mJJBias_vs_Mjj_%s", mJJBin.c_str()),  30, 0., 3000., -2., 2.,  mjjreco, mJJBias );
