...
void analysisClass::Loop()
{
   ...
   //////////book histos here
   double ptBins[] = {60, 140, 190, 215, 240, 270, 300, 390, 2500};                                                           
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) { // running over all events
	 ...
	 CreateAndFillUserTH1D("deltaEtaJJ_passHLT_HT450", 100, 0, 3, deltaETAjjreco); 
       ...
       if( passHLT_PFHT800 ){
	 CreateAndFillUserTH1D("mJJ_passHLT_PFHT800", 30, 0, 3000, mjjreco); 
	 ...
	 CreateAndFillUserTH1D("mJJ_passHLT_PFHT650MJJ950", 30, 0, 3000, mjjreco); 
	 ...
	 CreateAndFillUserTH1D("mJJ_passHLT_PFHT650MJJ900", 30, 0, 3000, mjjreco); 
	 ...
	 if( AK4Comparison ){
	   ...
	   if( DeltaReco1HLT1 <= DeltaReco2HLT1 )
	     {
	       IdxMatched =  0 ; // index Reco jets
	       deltaR_min   = DeltaReco1HLT1;
	       deltaR_min2 = DeltaReco2HLT2;
	     }else
	     {
	       IdxMatched = 1 ; // index Reco jets
	       deltaR_min   = DeltaReco2HLT1;
	       deltaR_min2 = DeltaReco1HLT2;
	     }
	   ...
	   if(deltaR_min < DeltaR_ ){   
	     ...
	     if(verbose){
	       ...
	       std::cout<<"Pt= "<< AK4recojets[IdxMatched].Pt()<<" Eta= "<<AK4recojets[IdxMatched].Eta()<< " Phi= "<<AK4recojets[IdxMatched].Phi()  <<std::endl;
	       std::cout<<"HLT" <<std::endl;
	       std::cout<<"Pt= "<< AK4jets[0].Pt()<<" Eta= "<<AK4jets[0].Eta()<< " Phi= "<<AK4jets[0].Phi()  <<std::endl;
	     }

	     h_pTJet_Binned -> Fill( AK4jets[0].Pt() );	       

	     // Reco variables
	     CreateAndFillUserTH1D("AK4_pT_JetReco", 30, 0, 3000, AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTH1D("AK4_Eta_JetReco", 20, -2.5, 2.5, AK4recojets[IdxMatched].Eta() );
	     CreateAndFillUserTH1D("AK4_Phi_JetReco", 100, -3.15, 3.15, AK4recojets[IdxMatched].Phi() );
	     CreateAndFillUserTH1D("AK4_chargedHadEnFracReco", 100, 0, 1, chargedHadEnFracReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_neutrHadEnFracReco", 100, 0, 1, neutrHadEnFracReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_chargedElectromFracReco", 100, 0, 1, chargedElectromFracReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_neutrElectromFracReco", 100, 0, 1, neutrElectromFracReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_muEnFracReco", 100, 0, 1, muEnFracReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_chargedMultReco", 100, 0, 100, chargedMultReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_neutrMultReco", 100, 0, 100, neutrMultReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_photonMultReco", 100, 0, 100, photonMultReco[IdxMatched] );
	     CreateAndFillUserTH1D("AK4_jetCSVAK4Reco", 100, 0, 2, jetCSVAK4Reco[IdxMatched] );
	     // HLT variables
	     CreateAndFillUserTH1D("AK4_pT_JetHLT", 30, 0, 3000, AK4jets[0].Pt() );
	     CreateAndFillUserTH1D("AK4_Eta_JetHLT", 20, -2.5, 2.5, AK4jets[0].Eta() );
	     CreateAndFillUserTH1D("AK4_Phi_JetHLT", 100, -3.15, 3.15, AK4jets[0].Phi() );
	     CreateAndFillUserTH1D("AK4_chargedHadEnFracHLT", 100, 0, 1, chargedHadEnFrac[0] );
	     CreateAndFillUserTH1D("AK4_neutrHadEnFracHLT", 100, 0, 1, neutrHadEnFrac[0] );
	     CreateAndFillUserTH1D("AK4_chargedElectromFracHLT", 100, 0, 1, chargedElectromFrac[0] );
	     CreateAndFillUserTH1D("AK4_neutrElectromFracHLT", 100, 0, 1, neutrElectromFrac[0] );
	     CreateAndFillUserTH1D("AK4_muEnFracHLT", 100, 0, 1, muEnFrac[0] );
	     CreateAndFillUserTH1D("AK4_chargedMultHLT", 100, 0, 100, chargedMult[0] );
	     CreateAndFillUserTH1D("AK4_neutrMultHLT", 100, 0, 100, neutrMult[0] );
	     CreateAndFillUserTH1D("AK4_photonMultHLT", 100, 0, 100, photonMult[0] );
	     CreateAndFillUserTH1D("AK4_jetCSVAK4HLT", 100, 0, 2, jetCSVAK4[0] );
	     // Reco vs HLT
	     CreateAndFillUserTH2D("AK4_pT_Jet", 30, 0, 3000, 30, 0, 3000, AK4recojets[IdxMatched].Pt(), AK4jets[0].Pt() );
	     CreateAndFillUserTH2D("AK4_Eta_Jet", 20, -2.5, 2.5, 20, -2.5, 2.5, AK4recojets[IdxMatched].Eta(), AK4jets[0].Eta() );
	     CreateAndFillUserTH2D("AK4_Phi_Jet", 100, -3.15, 3.15, 100, -3.15, 3.15, AK4recojets[IdxMatched].Phi(), AK4jets[0].Phi() );
	     CreateAndFillUserTH2D("AK4_chargedHadEnFrac", 100, 0, 1, 100, 0, 1, chargedHadEnFracReco[IdxMatched], chargedHadEnFrac[0] );
	     CreateAndFillUserTH2D("AK4_neutrHadEnFrac", 100, 0, 1, 100, 0, 1, neutrHadEnFracReco[IdxMatched], neutrHadEnFrac[0] );
	     CreateAndFillUserTH2D("AK4_chargedElectromFrac", 100, 0, 1, 100, 0, 1, chargedElectromFracReco[IdxMatched], chargedElectromFrac[0] );
	     CreateAndFillUserTH2D("AK4_neutrElectromFrac", 100, 0, 1, 100, 0, 1, neutrElectromFracReco[IdxMatched], neutrElectromFrac[0] );
	     CreateAndFillUserTH2D("AK4_muEnFrac", 100, 0, 1, 100, 0, 1, muEnFracReco[IdxMatched], muEnFrac[0] );
	     CreateAndFillUserTH2D("AK4_chargedMult", 100, 0, 100, 100, 0, 100, chargedMultReco[IdxMatched], chargedMult[0] );
	     CreateAndFillUserTH2D("AK4_neutrMult", 100, 0, 100, 100, 0, 100, neutrMultReco[IdxMatched], neutrMult[0] );
	     CreateAndFillUserTH2D("AK4_photonMult", 100, 0, 100, 100, 0, 100, photonMultReco[IdxMatched], photonMult[0] );
	     CreateAndFillUserTH2D("AK4_jetCSVAK4", 100, 0, 2, 100, 0, 2, jetCSVAK4Reco[IdxMatched], jetCSVAK4[0] );
	     
	     // Bias in pT AK4
	     // pT(Reco) - pT(HLT) / pT(HLT)	   
	     double pTBias = (AK4recojets[IdxMatched].Pt() - AK4jets[0].Pt() ) / AK4jets[0].Pt();
	     if(verbose) std::cout<<"pT Bias= "<<pTBias << std::endl;

	     int AK4_etaBin = mEtaBinning.getBin( fabs(AK4jets[0].Eta()) );
	     int AK4_ptBin   = mPtBinning.getPtBin( AK4jets[0].Pt() );
	     ...
	     if( verbose ){	       
	       cout<<"AK4: |Eta| =   "<< fabs( AK4jets[0].Eta() ) << " pT = "<< AK4jets[0].Pt() <<endl;
	     ...
	     CreateAndFillUserTProfile("AK4_pT_vs_NvtxReco", 50, 0., 50., 0., 5000., nVtxreco, AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile("AK4_pT_vs_NvtxHLT",  50, 0., 50., 0., 5000., nVtx, AK4jets[0].Pt() );
	     CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Nvtx_%s", AK4_Bin.c_str()),  50, 0., 50., -2., 2.,      nVtx, pTBias );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_NvtxReco_%s", AK4_Bin.c_str()), 50, 0., 50., 0., 5000., nVtxreco, AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_NvtxHLT_%s", AK4_Bin.c_str()),  50, 0., 50., 0., 5000., nVtx, AK4jets[0].Pt() );
	     ////// TProfile: pTBias vs Eta
	     CreateAndFillUserTProfile("AK4_pTBias_vs_Eta",  20, -2.5, 2.5, -2., 2.,      AK4jets[0].Eta(), pTBias );
	     CreateAndFillUserTProfile("AK4_pT_vs_EtaReco", 20, -2.5, 2.5, 0., 5000., AK4recojets[IdxMatched].Eta(), AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile("AK4_pT_vs_EtaHLT",  20, -2.5, 2.5, 0., 5000., AK4jets[0].Eta(), AK4jets[0].Pt() );
	     CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Eta_%s", AK4_PtBin.c_str()),  20, -2.5, 2.5, -2., 2.,      AK4jets[0].Eta(), pTBias );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_EtaReco_%s", AK4_PtBin.c_str()), 20, -2.5, 2.5, 0., 5000., AK4recojets[IdxMatched].Eta(), AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_EtaHLT_%s", AK4_PtBin.c_str()),  20, -2.5, 2.5, 0., 5000., AK4jets[0].Eta(), AK4jets[0].Pt() );
	     ////// TProfile: pTBias vs Pt
	     CreateAndFillUserTProfile("AK4_pTBias_vs_Pt",  50, 0., 5000., -2., 2.,      AK4jets[0].Pt(), pTBias );
	     CreateAndFillUserTProfile("AK4_pT_vs_PtReco", 50, 0., 5000., 0., 5000., AK4recojets[IdxMatched].Pt(), AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile("AK4_pT_vs_PtHLT",  50, 0., 5000., 0., 5000., AK4jets[0].Pt(), AK4jets[0].Pt() );	      
	     CreateAndFillUserTProfile( Form("AK4_pTBias_vs_Pt_%s", AK4_EtaBin.c_str()),  50, 0., 5000., -2., 2.,      AK4jets[0].Pt(), pTBias );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_PtReco_%s", AK4_EtaBin.c_str()), 50, 0., 5000., 0., 5000., AK4recojets[IdxMatched].Pt(), AK4recojets[IdxMatched].Pt() );
	     CreateAndFillUserTProfile( Form("AK4_pT_vs_PtHLT_%s", AK4_EtaBin.c_str()),  50, 0., 5000., 0., 5000., AK4jets[0].Pt(), AK4jets[0].Pt() );	      
