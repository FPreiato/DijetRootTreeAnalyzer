...
int main(int argc, char* argv[]) {
  ...
  dataFileName_ZeroBias = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_ZeroBias.root" );
  TString dataFileName_DoubleMu; // #2
  dataFileName_DoubleMu = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_DoubleMu.root" );
  TString dataFileName_CaloJet40; // #3
  dataFileName_CaloJet40 = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_CaloJet40.root" );
  TString dataFileName_L1HTT150; // #4
  dataFileName_L1HTT150 = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_L1HTT150.root" );
  TString dataFileName_HT250; // #5
  dataFileName_HT250 = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_HT250.root" );
  TString dataFileName_HT450; // #6
  dataFileName_HT450 = TString::Format("/cmshome/fpreiato/Scouting_Dijet/CMSSW_7_4_15/src/CMSDIJET/DijetRootTreeAnalyzer/output/HLTReco_plus_Asymmetry/rootFile_JEC_HLT_v7_RecoLowerCuts_pTCut10GeV_HT450.root" );
