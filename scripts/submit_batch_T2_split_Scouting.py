...
usage = "usage: python scripts/submit_batch_T2_split_Scouting.py -q cmslong -i config/list_to_run -o output --split 10 --tag TAG -c config/cutFile_mainDijetCaloScoutingMonitor.txt"
